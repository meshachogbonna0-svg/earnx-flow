  ...
  head: () => ({
    meta: [
      { title: "Create Your Free Account — EarnX-Finance" },
      {
        name: "description",
        content:
          "Register on EarnX-Finance in under a minute, verify your email and claim your configured welcome bonus.",
      },
      { property: "og:title", content: "Create Your Free Account — EarnX-Finance" },
      {
        property: "og:description",
        content: "Register, verify your email and claim your configured welcome bonus.",
      },
...
function RegisterPage() {
  ...
  return (
    <AuthShell
      ...
      subtitle={
        welcomeBonus !== null
          ? `It takes under a minute. Verify your email to claim your ${naira(welcomeBonus)} welcome bonus.`
          : "It takes under a minute. Verify your email to claim your configured welcome bonus."
      }
      footer={
        <>
