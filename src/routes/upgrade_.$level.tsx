      ...
      <section className="animate-fade-up rounded-2xl border border-gold/40 bg-gradient-to-br from-navy via-card to-navy-deep p-5 text-center shadow-gold-glow">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2 text-left">
          <div className="rounded-xl border border-gold/20 bg-gold/10 p-2.5">
            ...
            <p className="mt-1 text-xs font-bold text-gold">{plan.upgrade_price > 0 ? naira(plan.upgrade_price) : "Free"}</p>
          </div>
          <div className="rounded-xl border border-royal/30 bg-royal/10 p-2.5">
            <p className="text-[9px] font-semibold uppercase tracking-wider text-muted-foreground">Later activation</p>
            <p className="mt-1 text-xs font-bold text-royal">{plan.activation_fee > 0 ? naira(plan.activation_fee) : "Not configured"}</p>
          </div>
        </div>
      </section>
